...
## 🌟 Overview
Deep learning isn’t magic — it’s math, data, and computation working together.  
...
├── src/ — Supporting Python scripts (models, utils)  
...
1️⃣ Fundamentals → 2️⃣ CNNs → 3️⃣ RNNs → 4️⃣ Attention → 5️⃣ Generative Models → 6️⃣ Explainability  
...
## 🧩 Philosophy
> “Learn by coding, visualize to understand, explain to master.”

This project focuses on depth over breadth — understanding how deep learning works under the hood, not just using high-level APIs.

---

## 📜 License
MIT License © 2025 **Arjun Bhargava**  
For learning and educational use — please credit when reusing materials.
...
> _“Deep learning is not about stacking layers — it’s about understanding how they learn.”_
